...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 124, vars: 0, consts: [[1, "container-header"], [1, "header-left"], [1, "menu-header", 3, "click", "mouseover", "mouseleave"], [1, "example-container"], [1, "fas", "fa-2x", "fa-bars", "icon-header"], [1, "logo-header", 3, "click", "mouseover", "mouseleave"], ["src", "../../../assets/img/logo-risk.png", "alt", ""], [1, "actu-header", 3, "click", "mouseover", "mouseleave"], [1, "fas", "fa-exclamation-circle", "exclamation"], ["mode", "over", 1, "sidenav"], ["sidenav", ""], [1, "sidenav-header"], [1, "fas", "fa-2x", "fa-chevron-left", "icon-header"], [1, "pages", 3, "mouseover", "mouseleave"], [1, "page", 3, "click"], [1, "pages2", 3, "mouseover", "mouseleave"], ["mode", "over", "position", "end", 1, "sidenav2"], ["sidenav2", ""], [1, "sidenav-header2-container"], [1, "voirplus", 3, "click", "mouseover", "mouseleave"], [1, "fas", "fa-eye", "voirplus-icon"], [1, "sidenav-header2"], [1, "fas", "fa-2x", "fa-chevron-right", "icon-header"], [1, "cards-bottom"], [1, "card-container"], [1, "card-top"], ["src", "https://images.itnewsinfo.com/lmi/articles/grande/000000078736.jpg"], [1, "card-middle"], [1, "card-bottom"], [1, "date"], [1, "play"], [1, "type"], [1, "fas", "fa-eye"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [_angular_material_sidenav__WEBPACK_IMPORTED_MODULE_2__["MatSidenavContainer"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_2__["MatSidenavContent"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_2__["MatSidenav"]], styles: [".container-header[_ngcontent-%COMP%] {\n  width: 100vw;\n  height: 10vh;\n  padding: 10px 35px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: row;\n  position: fixed;\n  top: 0;\n  z-index: 1000;\n  box-shadow: 0 0 15px rgba(0, 0, 0, 0.7);\n  background-color: white;\n}\n\n.icon-header[_ngcontent-%COMP%] {\n  color: #641717 !important;\n  margin-right: 20px;\n  transition: 0.5s;\n}\n\n.header-left[_ngcontent-%COMP%] {\n  display: flex;\n  justify-items: flex-start;\n  align-items: center;\n  flex-direction: row;\n}\n\n.icon-header[_ngcontent-%COMP%]:hover {\n  color: #B21A1A !important;\n  transition: 0.5s;\n}\n\n.logo-header[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  object-fit: cover;\n  height: 8vh;\n}\n\n.actu-header[_ngcontent-%COMP%] {\n  padding: 15px;\n  transition: 1s;\n  font-weight: lighter;\n  font-size: large;\n  border-radius: 5px;\n  animation: urgent 1.5s infinite;\n}\n\n@keyframes urgent {\n  0% {\n    background-color: transparent;\n  }\n  45% {\n    background-color: #D4AEAE;\n  }\n  55% {\n    background-color: #D4AEAE;\n  }\n  100% {\n    background-color: transparent;\n  }\n}\n\n.actu-header[_ngcontent-%COMP%]:hover {\n  background-color: #F3F3F3;\n  transition: 0.5s;\n  animation: urgent2 0.8s infinite;\n}\n\n@keyframes urgent2 {\n  0% {\n    color: black;\n    background-color: transparent;\n  }\n  45% {\n    color: #401111;\n    background-color: #BB9999;\n  }\n  55% {\n    color: #401111;\n    background-color: #BB9999;\n  }\n  100% {\n    color: black;\n    background-color: transparent;\n  }\n}\n\n.sidenav[_ngcontent-%COMP%] {\n  width: 20vw;\n  z-index: 1500;\n  overflow-x: hidden;\n  overflow-y: hidden;\n}\n\n.sidenav-header[_ngcontent-%COMP%] {\n  height: 10vh;\n  padding: 10px 35px;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  flex-direction: row;\n  background-color: white;\n}\n\n.pages[_ngcontent-%COMP%], .pages2[_ngcontent-%COMP%] {\n  width: 100%;\n  display: flex;\n  justify-content: flex-start;\n  align-content: center;\n  flex-direction: column;\n}\n\n.pages[_ngcontent-%COMP%] {\n  border-bottom: #E5E6E4 solid 1px;\n  border-top: #E5E6E4 solid 1px;\n}\n\n.page[_ngcontent-%COMP%] {\n  padding-bottom: 20px;\n  padding-top: 20px;\n  transition: 0.5s;\n  padding-left: 35px;\n  font-weight: lighter;\n  font-size: large;\n}\n\n.page[_ngcontent-%COMP%]:hover {\n  background-color: #F3F3F3;\n  transition: 0.5s;\n}\n\n.title-cards[_ngcontent-%COMP%] {\n  font-weight: normal;\n  font-size: x-large;\n  color: #401111;\n  height: 5vh;\n  margin-bottom: 2vh;\n}\n\n.cards-bottom[_ngcontent-%COMP%] {\n  width: 100%;\n  margin: 0 auto;\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-gap: 10px;\n  border-top: #E5E6E4 solid 1px;\n  padding: 35px;\n  padding-top: 3vh;\n}\n\n.card-container[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-content: space-between;\n  flex-direction: column;\n  background-color: white;\n  transition: 0.5s;\n  z-index: 100;\n  border-radius: 10px;\n  margin-bottom: 15px;\n}\n\n.card-top[_ngcontent-%COMP%] {\n  width: 100%;\n  justify-self: flex-start;\n}\n\n.card-top[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  height: 10vh;\n  width: 100%;\n  object-fit: cover;\n  border-top-left-radius: 10px;\n  border-top-right-radius: 10px;\n}\n\n.card-middle[_ngcontent-%COMP%] {\n  font-weight: normal;\n  padding: 10px;\n  font-size: small;\n}\n\n.card-bottom[_ngcontent-%COMP%] {\n  color: #9D9999;\n  padding: 10px;\n  display: flex;\n  justify-content: space-between;\n  align-content: center;\n  flex-direction: row;\n  overflow-x: hidden !important;\n  overflow-y: scroll !important;\n}\n\n.date[_ngcontent-%COMP%] {\n  font-size: smaller;\n}\n\n.play[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  align-content: center;\n  flex-direction: row;\n}\n\n.play[_ngcontent-%COMP%]   .type[_ngcontent-%COMP%] {\n  padding-right: 10px;\n}\n\n.card-container[_ngcontent-%COMP%]:hover {\n  transition: 0.5s;\n  box-shadow: 0 0 5px rgba(0, 0, 0, 0.4);\n  transform: scale(1.05);\n}\n\n.card-container[_ngcontent-%COMP%]:hover   .play[_ngcontent-%COMP%] {\n  color: #006074;\n  transition: 0.5s;\n}\n\n.card-container[_ngcontent-%COMP%]:hover   .type[_ngcontent-%COMP%] {\n  color: #006074;\n  transition: 0.5s;\n}\n\n.table-ronde[_ngcontent-%COMP%] {\n  background-color: #F3F3F3 !important;\n}\n\n.end-page[_ngcontent-%COMP%] {\n  padding-bottom: 10vh;\n}\n\n.sidenav2[_ngcontent-%COMP%] {\n  width: 23vw;\n  background-color: #f5f5f5;\n  z-index: 1500;\n}\n\n.sidenav-header2-container[_ngcontent-%COMP%] {\n  height: 10vh;\n  padding: 10px 35px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background-color: white;\n}\n\n.sidenav-header2[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  height: 100%;\n}\n\n.mat-drawer.mat-drawer-side[_ngcontent-%COMP%] {\n  z-index: 1500 !important;\n}\n\n.voirplus-icon[_ngcontent-%COMP%] {\n  color: #006074;\n  margin-right: 10px;\n  transition: 0.5s;\n}\n\n.voirplus[_ngcontent-%COMP%] {\n  width: 60%;\n  transition: 0.5s;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  color: #9AAFB2;\n  font-weight: bold;\n}\n\n.voirplus[_ngcontent-%COMP%]:hover {\n  color: #006074;\n  transition: 0.5s;\n}\n\n.exclamation[_ngcontent-%COMP%] {\n  color: #641717;\n  margin-right: 10px;\n  animation: turn 1s infinite;\n}\n\n.mat-drawer-container[_ngcontent-%COMP%] {\n  background-color: transparent !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
